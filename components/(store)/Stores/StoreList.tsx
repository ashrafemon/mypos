            ...
            data={Array(10)
                ...
                .map((_, i) => (
                    <AppTableRow key={i}>
                        ...
                        <AppTableCell>01 Pharma Saio</AppTableCell>
                        <AppTableCell>000003</AppTableCell>
                        <AppTableCell>cambridge@traderjoes.com</AppTableCell>
                        <AppTableCell>(555)123-4567</AppTableCell>
                        <AppTableCell>
                            <Flex gap="xs">

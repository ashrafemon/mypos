import AccountTransferRepository from "@/backend/repositories/AccountTransferRepository";

export default class AccountTransferController {
    constructor(
        private readonly repository = new AccountTransferRepository()
    ) {}

import IncomeCategoryRepository from "@/backend/repositories/IncomeCategoryRepository";

export default class IncomeCategoryController {
    constructor(private readonly repository = new IncomeCategoryRepository()) {}
